...
set_target_properties(drsyscall PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsyscall.1.0.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsyscall.1.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsyscall.1.0.dylib" )
...
set_target_properties(drsyscall_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsyscall_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall_static "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsyscall_static.a" )
...
set_target_properties(drsymcache PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsymcache.1.0.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsymcache.1.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsymcache.1.0.dylib" )
...
set_target_properties(drsymcache_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsymcache_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache_static "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsymcache_static.a" )
...
set_target_properties(umbra PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libumbra.1.0.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "libumbra.1.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra "${_IMPORT_PREFIX}/drmf/lib32/release/libumbra.1.0.dylib" )
...
set_target_properties(umbra_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "dynamorio;drmgr_static;drcontainers"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libumbra_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra_static "${_IMPORT_PREFIX}/drmf/lib32/release/libumbra_static.a" )
...
set_target_properties(drfuzz PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrfuzz.1.0.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrfuzz.1.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz "${_IMPORT_PREFIX}/drmf/lib32/release/libdrfuzz.1.0.dylib" )
...
set_target_properties(drfuzz_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrfuzz_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz_static "${_IMPORT_PREFIX}/drmf/lib32/release/libdrfuzz_static.a" )
